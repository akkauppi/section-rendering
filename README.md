...
- Visibility currently compares candidate edges with all supplied faces, and interface merging is pairwise after broad-phase filtering. Pre-filter or partition very large triangle meshes rather than treating this as a general scene renderer.
